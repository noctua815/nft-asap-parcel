...
const initHeroAnimation = ()=>{
    ...
    for (let [i, item] of items.entries())(0, _gsap.gsap).to(item, {
        opacity: 1,
        y: 0,
        duration: 1,
        ease: "ease-out",
...
class NftSlider {
    constructor(){
        ...
        this.DOM.slides = [
            ...this.DOM.slider.querySelectorAll(".nft-card")
        ];
    ...
    initSliderClick() {
        this.DOM.btn.addEventListener("click", ()=>{
            ...
            (0, _gsap.gsap).to(this.DOM.activeSlide, {
                x: slideWidth * -1,
                opacity: 0,
                ease: "power1",
                duration: 0.3,
    ...
    moveFirstSlide() {
        ...
        (0, _gsap.gsap).to(this.DOM.lastItem, {
            duration: 0,
            scale: 0.1,
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequired325")
